namespace UcabGo.App.Utils
{
    ...
    internal class SimpleRatingControl : HorizontalStackLayout
    {
        ...
        private void UpdateLayout()
        {
            ...
            //CurrentValue = intValue; //Added to avoid decimal values
        ...
        private Label CreateStarLabel(StarState state)
        {
            return new Label
            {
                ...
                Text = state switch
                {
                    StarState.Empty => IconFont.Star_outline,
                    StarState.Half => IconFont.Star_half,
                    StarState.Full => IconFont.Star,
                    _ => IconFont.Star_outline,
                }
            };
        }
